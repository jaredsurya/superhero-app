...
const Profile = ({user, setUser}) => {
  ...
  <form onSubmit={handleSubmit}>
    ...
    <input type="email" id="email" name="email" value={user.email} onChange={(e) => setUser({...user, "email": e.target.value})}/><br/><br/>
    <label>Enter a short bio, 250 character max:</label><br/>
    <textarea type="text" id="bio" name="bio" maxLength="250" value={user.bio} onChange={(e) => setUser({...user, "bio": e.target.value})}/><br/><br/>
    <input type="submit"/>
  </form>
</div>
